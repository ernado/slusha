# Start message
start-msg = Привет! Я Светик, бот-гений.
...
character-already-set = Светик уже стоит
character-set = Установлена Светик
...
character-names-help = Напиши варианты имени "{ $characterName }", которые пользователи могут использовать в качестве обращения к этому персонажу. Варианты должны быть на русском, английском, уменьшительно ласкательные и очевидные похожие формы.
    Пример: имя "Cute Slusha". Варианты: ["Cute Slusha", "Slusha", "Светик", "Светикня", "слюшка", "шлюша", "слюш"]
...
# Opt-out commands
opt-out-users-list = \n\n Пользователи, которых не видит Светик:\n

opt-out-confirm = <b>Светик больше не будет видеть твои сообщения в этом чате.</b>
...
opt-out-status = Ура, Светик { $verb } видит твои сообщения
...
character-set-slusha = Установлена Светик
