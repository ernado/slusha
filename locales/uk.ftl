# Start message
start-msg = Привіт! Я Светик, бот-геній.
...
character-already-set = Светик вже стоїть
character-set = Встановлена Светик
...
character-names-help = Напиши варіанти імені "{ $characterName }", які користувачі можуть використовувати як звернення до цього персонажа. Варіанти повинні бути українською, англійською, зменшувально-пестливими та очевидними схожими формами.
    Приклад: ім'я "Cute Slusha". Варіанти: ["Cute Slusha", "Slusha", "Светик", "Светикня", "слюшка", "шлюша", "слюш"]
...
# Opt-out commands
opt-out-users-list = \n\n Користувачі, яких не бачить Светик:\n

opt-out-confirm = <b>Светик більше не буде бачити твої повідомлення в цьому чаті.</b>
...
opt-out-status = Ура, Светик { $verb } бачить твої повідомлення
...
character-set-slusha = Встановлена Светик
